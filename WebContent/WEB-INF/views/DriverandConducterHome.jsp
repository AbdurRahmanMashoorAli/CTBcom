...
<body>
	<div class="container">
        <div class="card">
            <div class="imgbox" data-text="Services Details">
        ...
        <div class="card">
            ...
            <div class="content">
                <h3>Route Details</h3>
                <p>Click on below to find the location of the Buses</p>
                <a href="routedetails.php">Click here</a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="content">
                ...
                <p>Click on below to view driver details</p>
                <a href="driverdetails.php">Click here</a>
            </div>
        </div>
    </div>
    <?php if(isset($_SESSION['success'])) : ?>
        ...
        ?>
    <?php endif ?>
    <?php if (isset($_SESSION['DLicNo'])) : ?>
        
        <h6>welcome <?php echo $_SESSION['DLicNo']; ?></h6>

        <button><a href="DriverandConducterHome.php?logout='1'"></a></button>
