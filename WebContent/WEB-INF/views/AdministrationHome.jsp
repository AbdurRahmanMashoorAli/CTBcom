...
<body>
	<div class="container">
        <div class="card">
            ...
            <div class="content">
                <h3>Bus Details</h3>
                <p>Click on below to view bus Details</p>
        ...
        <div class="card">
            ...
            <div class="content">
                <h3>Route Details</h3>
                <p>Click on below to view route details</p>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <p>Click on below to add new employees</p>
                <a href="NewEmployee.php">Click here</a>
            </div>
        </div>
    </div>
    <?php
    ...
    <?php if (isset($_SESSION['AdminID'])) : ?>
        ...
        <h6>welcome <?php echo $_SESSION['AdminID']; ?></h6>

        <button><a href="Administration.php?logout='1'"></a></button>
